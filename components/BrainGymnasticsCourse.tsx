        ...
        <div className="grid lg:grid-cols-2 gap-10 lg:gap-20 items-center">
          ...
          <div className="order-2 lg:order-1 relative group">
            <div className="relative aspect-video rounded-2xl md:rounded-[40px] overflow-hidden border border-gold/20 shadow-2xl bg-dark-surface z-10">
              <iframe 
                ...
                src="https://www.youtube.com/embed/2qCyBSM3s3w" 
          ...
          <div className="space-y-6 md:space-y-10 order-1 lg:order-2">
            ...
            <div className="flex items-baseline gap-3 pt-2">
              <span className="text-3xl md:text-4xl font-serif font-black text-cream">$27</span>
              <span className="text-base font-bold text-cream/60">USD</span>
              <span className="text-xs text-cream/40 font-medium">· Pago único · 6 meses de acceso</span>
            </div>

            <div className="flex flex-col sm:flex-row flex-wrap gap-4 md:gap-6 pt-2 md:pt-4">
              <a 
                href="https://pay.hotmart.com/O105440794G?off=5w5uhcm6&bid=1776479534401" 
                target="_blank"
